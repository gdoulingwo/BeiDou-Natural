...
var get_style_by_disaster_rank = function (index_rank)
{
    ...
    if(zoom_num < 8)
    {
        ...
        switch(index_rank)
        {
            case 1: radius = 48; break;
            case 2: radius = 32;break;
            case 3: radius = 24;break;
            case 4: radius = 16;break;
            default: radius = 100;break;
        }
    }
    else if(zoom_num < 10)
    {
        ...
        switch(index_rank)
        {
            case 1: radius = 64; break;
            case 2: radius = 48;break;
            case 3: radius = 32;break;
            case 4: radius = 16;break;
            default: radius = 100;break;
        }
    }
    else
    {
        ...
        switch(index_rank)
        {
            ...
            case 3: radius = 64;break;
            case 4: radius = 64;break;
            default: radius = 100;break;
        }
    }
