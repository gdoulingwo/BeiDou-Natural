var displayFeatureBeidouLog = function (feature, coordinate) {
    ...
    switch (disaster_rank_of_log) {
        case 1:
            disaster_rank_str = '特别重大I级';
            break;
        case 2:
            disaster_rank_str = '重大Ⅱ级';
            break;
        case 3:
            disaster_rank_str = '较大Ⅲ级';
            break;
        case 4:
            disaster_rank_str = '一般Ⅳ级';
            break;
        default:
            disaster_rank_str = '未知';
            break;
    }
    ...
    $.ajax({
        ...
        data: {
            ...
            dead_population: DeadPopulation,
            building_collapse: BuildingCollapse
        },
        success: function (data) {
            $('#plan-title').html(data.name);
            $('#plan-content').html(data.content);
        }
    });
}

var displaySnap = function (coordinate, type) {
