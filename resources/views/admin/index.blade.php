...
<div id="sidebar" class="sidebar collapsed"> <!-- collapsed -->
    ...
    <div class="sidebar-tabs">
        <ul role="tablist">
            ...
            <li><a href="#geo-animation" role="tab"><i class="fa fa-play-circle-o fa-fw" aria-hidden="true"></i></a></li>
        </ul>
        <ul role="tablist">
            <li><a href="#disaster-log-info" role="tab"><i class="fa fa-file-text-o fa-fw" aria-hidden="true"></i></a></li>
            <li><a href="#whole-history-log-info" role="tab"><i class="fa fa-calculator fa-fw" aria-hidden="true"></i></a></li>
        </ul>
    </div>
    ...
    <div class="sidebar-content">
        <div class="sidebar-pane" id="map-view">
            <h1 class="sidebar-header"><label>地图显示参数</label><span class="sidebar-close"><i class="fa fa-caret-left"></i></span></h1>
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                <form class="form-inline">
                                    ...
                                    <div class="form-group">
                                        <input id="auto-load-n-second-input" type="range" min="10" max="6000" step="10" value="60"/>
                                    </div>
                                </form>
                            </li>
                        </ul>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table id="ship-icon-table" class="table table-condensed">
                            ...
                            <!--<tr>
                                <td><img class="img-responsive" src="./img/rank_1.png" alt="特别重大I级" id="img-red"
                                         onmouseover="geoMoveOver(this);" onmouseout="geoMoveOut(this);"></td>
                                <td><img class="img-responsive" src="./img/rank_2.png" alt="重大Ⅱ级" id="img-orange"
                                         onmouseover="geoMoveOver(this);" onmouseout="geoMoveOut(this);"></td>
                                <td><img class="img-responsive" src="./img/rank_3.png" alt="较大Ⅲ级" id="img-yellow"
                                         onmouseover="geoMoveOver(this);" onmouseout="geoMoveOut(this);"></td>
                                <td><img class="img-responsive" src="./img/rank_4.png" alt="一般Ⅳ级" id="img-blue"
                                         onmouseover="geoMoveOver(this);" onmouseout="geoMoveOut(this);"></td>
                            </tr>-->
                            <tr>
                            <td><img class="img-responsive" src="/img/rank_1.png" alt="特别重大I级" id="img-red"></td>
                            <td><img class="img-responsive" src="/img/rank_2.png" alt="重大Ⅱ级" id="img-orange"></td>
                            <td><img class="img-responsive" src="/img/rank_3.png" alt="较大Ⅲ级" id="img-yellow"></td>
                            <td><img class="img-responsive" src="/img/rank_4.png" alt="一般Ⅳ级" id="img-blue"></td>
                            </tr>
                        </table>
                        <!--
                        <ul class="list-group">
                            <li class="list-group-item list-group-item-success">
                                <div>
                                    <label class="checkbox-inline"><input type="checkbox" value="" checked="checked" id="check-all-vessel-type">全选</label>
                                    <label class="checkbox-inline"><input type="checkbox" value="" id="uncheck-all-vessel-type">全不选</label>
                                </div>
                                <div>
                                    <label class="checkbox-inline"><input type="checkbox" value="" checked="checked" id="check-dantuo">特别重大I级</label>
                                    <label class="checkbox-inline"><input type="checkbox" value="" checked="checked" id="check-suangtuo">重大Ⅱ级</label>
                                </div>
                                <div>
                                    <label class="checkbox-inline"><input type="checkbox" value="" checked="checked" id="check-zhaowang">较大Ⅲ级</label>
                                    <label class="checkbox-inline"><input type="checkbox" value="" checked="checked" id="check-ciwang">一般Ⅳ级</label>
                                </div>
                            </li>
                        </ul>
                        -->
        ...
        <div class="sidebar-pane" id="data-list">
            <h1 class="sidebar-header"><label>事件列表</label><span class="sidebar-close"><i class="fa fa-caret-left"></i></span></h1>
            <div class="panel-group">
                <div class="panel panel-default">
                    <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="input" class="form-control" id="input-search-log" placeholder="试着查找......" value="">
                        </div>
        ...
        <div class="sidebar-pane" id="geo-animation">
            <h1 class="sidebar-header"><label>数据动画播放</label><span class="sidebar-close"><i class="fa fa-caret-left"></i></span></h1>
            <div class="panel-group">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item">
                                <form class="form-inline">
                                    ...
                                    <div class="form-group">
                                        <input id="display-n-frame-input" type="range" min="1" max="5" step="1" value="3"/>
                                    </div>
                                </form>
                            </li>
                            <li class="list-group-item">
                            ...
                            <li class="list-group-item">
                                <label>动画绘图模式：</label>
                                <label class="radio-inline"><input type="radio" class="btn btn-primary btn-md" name="animation-mode" checked>重绘</label>
                                <label class="radio-inline"><input type="radio" class="btn btn-primary btn-md" name="animation-mode"
                                                                   id="radio-animation-add-mode">叠加</label>
                            </li>
                            <li class="list-group-item">
                                <label>动画播放数据单位：</label>
                                <label class="radio-inline"><input type="radio" name="animation-unit" id="radio-animation-disaster" checked>灾害</label>
                                <label class="radio-inline"><input type="radio" name="animation-unit" id="radio-animation-day">天</label>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div>
                            <button type="button" class="btn btn-primary btn-md" id="display-start-animation">播放</button>
